...
|P24|transferred title of (changed ownership through)|a transféré le titre de propriété de (a changé de propriétaire par)|`P24_a_transféré_le_titre_de_propriété_de (a_changé_de_propriétaire_par)`<br>Le transfert, l'acquisition et la cession sont des termes plus proches de la réalité juridique et semblent donc plus appropriés.|
