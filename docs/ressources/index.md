...
<td><code class="language-plaintext highlighter-rouge">P1_est_identifié_par</code> </td>
</tr>
<tr class="odd">
<td>P2</td>
<td>has type (is type of)</td>
<td>a pour type (est type de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P2_a_pour_type</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P4_a_pour_intervalle_temporel</code> </td>
</tr>
<tr class="even">
<td>P5</td>
<td>consists of (forms part of)</td>
<td>consiste en (fait partie de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P5_consiste_en</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P7_a_eu_lieu_dans</code> </td>
</tr>
<tr class="even">
<td>P8</td>
<td>took place on or within (witnessed)</td>
<td>a eu lieu à (a été témoin de)</td>
<td><code class="language-plaintext highlighter-rouge">P8_a_eu_lieu</code> </td>
</tr>
<tr class="odd">
<td>P9</td>
<td>consists of (forms part of)</td>
<td>comprend (fait partie de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P9_comprend</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P10_s’insère_dans_le_cours_de</code> </td>
</tr>
<tr class="odd">
<td>P11</td>
<td>had participant (participated in)</td>
<td>a eu pour participant (a participé à)</td>
<td><p><code class="language-plaintext highlighter-rouge">P11_a_eu_pour_participant</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P12_a_eu_lieu_en_présence_de</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P13_a_détruit</code> </td>
</tr>
<tr class="even">
<td>P14</td>
<td>carried out by (performed)</td>
<td>a été effectué par (a effectué)</td>
<td><p><code class="language-plaintext highlighter-rouge">P14_a_été_effectué_par</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P15_a_été_influencé_par</code> </td>
</tr>
<tr class="even">
<td>P16</td>
<td>used specific object (was used for)</td>
<td>a utilisé l'objet spécifique (a été utilisé pour)</td>
<td><code class="language-plaintext highlighter-rouge">P16_a_utilisé_l’objet_spécifique</code> </td>
</tr>
<tr class="odd">
<td>P17</td>
<td>was motivated by (motivated)</td>
<td>a été motivé par (a motivé)</td>
<td><code class="language-plaintext highlighter-rouge">P17_a_été_motivé_par</code> </td>
</tr>
<tr class="even">
<td>P19</td>
<td>was intended use of (was made for):</td>
<td>a été l'usage prévu de (a été élaboré pour)</td>
<td><p><code class="language-plaintext highlighter-rouge">P19_a_été_l’usage_prévu_de</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P20_a_eu_pour_finalité_spécifique</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P21_a_eu_pour_finalité_générale</code> </td>
</tr>
<tr class="odd">
<td>P22</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P22_a_transféré_le_titre_de_propriété_à</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P23_a_transféré_le_titre_de_propriété_de</code> </p>
<p>Le transfert, l'acquisition et la cession sont des termes plus proches de la réalité juridique et semblent donc plus appropriés.</p></td>
</tr>
<tr class="odd">
<td>P24</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P24_a_transféré_le_titre_de_propriété_du</code> </p>
<p>Le transfert, l'acquisition et la cession sont des termes plus proches de la réalité juridique et semblent donc plus appropriés.</p></td>
</tr>
<tr class="even">
<td>P25</td>
...
<td><code class="language-plaintext highlighter-rouge">P25_a_déplacé</code> </td>
</tr>
<tr class="odd">
<td>P26</td>
<td>moved to (was destination of)</td>
<td>a déplacé à (a été la destination de)</td>
<td><code class="language-plaintext highlighter-rouge">P26_a_déplacé_à</code> </td>
</tr>
<tr class="even">
<td>P27</td>
<td>moved from (was origin of)</td>
<td>a déplacé depuis (a été le point de départ de)</td>
<td><code class="language-plaintext highlighter-rouge">P27_a_déplacé_depuis</code> </td>
</tr>
<tr class="odd">
<td>P28</td>
<td>custody surrendered by (surrendered custody through)</td>
<td>a mis fin à la garde par (a cédé la garde par)</td>
<td><p><code class="language-plaintext highlighter-rouge">P28_a_mis_fin_à_la_garde_par</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P29_a_confié_la_garde_par</code> </p>
<p>L'utilisation du terme par est cohérent avec les autres propositions et plus simple.</p></td>
</tr>
<tr class="odd">
<td>P30</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P30_a_transféré_la_garde_de</code> </p>
<p>L'utilisation du terme par est cohérent avec les autres propositions et plus simple.</p></td>
</tr>
<tr class="even">
<td>P31</td>
...
<td><code class="language-plaintext highlighter-rouge">P31_a_modifié</code> </td>
</tr>
<tr class="odd">
<td>P32</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P32_a_utilisé_comme_technique_générale</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P33_a_utilisé_comme_technique_spécifique</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P34_a_porté_sur</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P35_a_identifié</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="odd">
<td>P37</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P37_a_attribué</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="even">
<td>P38</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P38_a_retiré_l’attribution_de</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="odd">
<td>P39</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P39_a_mesuré</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="even">
<td>P40</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P40_a_relevé_comme_dimension</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="odd">
<td>P41</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P41_a_classifié</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="even">
<td>P42</td>
<td>assigned (was assigned by)</td>
<td>a attribué (a été attribué lors de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P42_a_attribué</code> </p>
<p>Puisqu'il s'agit de l'évènement et non de la personne, lors de semble plus approprié et cohérent avec le reste de la traduction.</p></td>
</tr>
<tr class="odd">
<td>P43</td>
...
<td><code class="language-plaintext highlighter-rouge">P43_a_pour_dimension</code> </td>
</tr>
<tr class="even">
<td>P44</td>
<td>has condition (is condition of)</td>
<td>a pour état matériel (est état matériel de)</td>
<td><code class="language-plaintext highlighter-rouge">P44_a_pour_état_matériel</code> </td>
</tr>
<tr class="odd">
<td>P45</td>
<td>consists of (is incorporated in)</td>
<td>consiste en (inclut)</td>
<td><p><code class="language-plaintext highlighter-rouge">P45_consiste_en</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P46_est_composé_de</code> </p>
<p>Cette formulation est cohérente avec le reste de la traduction (P5 "consists of (forms part of); consiste en (fait partie de)").</p>
...
<td><code class="language-plaintext highlighter-rouge">P48_a_pour_identifiant_préférentiel</code> </td>
</tr>
<tr class="even">
<td>P49</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P49_a_pour_détenteur_actuel_ou_antérieur</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P50_a_pour_détenteur_actuel</code> </p>
<p>L'utilisation du terme détenteur semble préférable dans la mesure où il reconnaît à la fois la responsabilité légale ainsi que la détention de l'objet, ce à quoi le terme "keeper" fait allusion (en plus de la définition qui parle de "custody" et non pas de "responsibility"</p></td>
</tr>
<tr class="even">
<td>P51</td>
...
<td><code class="language-plaintext highlighter-rouge">P51_a_pour_propriétaire_actuel_ou_antérieur</code> </td>
</tr>
<tr class="odd">
<td>P52</td>
<td>has current owner (is current owner of)</td>
<td>a pour propriétaire actuel (est propriétaire actuel de)</td>
<td><code class="language-plaintext highlighter-rouge">P52_a_pour_propriétaire_actuel</code> </td>
</tr>
<tr class="even">
<td>P53</td>
...
<td><code class="language-plaintext highlighter-rouge">P53_a_pour_localisation_actuelle_ou_antérieure</code> </td>
</tr>
<tr class="odd">
<td>P54</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P54_a_actuellement_pour_localisation_fixe</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P55_a_actuellement_pour_localisation</code> </td>
</tr>
<tr class="odd">
<td>P56</td>
<td>bears feature (is found on)</td>
<td>a pour caractéristique (se trouve sur)</td>
<td><p><code class="language-plaintext highlighter-rouge">P56_a_pour_caractéristique</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P59_a_pour_section</code> </p>
<p>L'utilisation d'une formulation cohérente entre P56, P57, P59, etc. semble appropriée.</p></td>
</tr>
<tr class="even">
<td>P62</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P62_illustre</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P65_représente_l’entité_visuelle</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P67_renvoie_à</code> </td>
</tr>
<tr class="odd">
<td>P68</td>
<td>foresees use of (use foreseen by)</td>
<td>prévoit l'usage de (usage prévu de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P68_prévoit_l’usage_de</code> </p>
<p>Cette formulation est cohérente avec le reste de la traduction (P19, P68).</p></td>
</tr>
<tr class="even">
<td>P69</td>
...
<td><code class="language-plaintext highlighter-rouge">P70_documente</code> </td>
</tr>
<tr class="even">
<td>P71</td>
<td>lists (is listed in)</td>
<td>énumère (est énuméré par)</td>
<td><code class="language-plaintext highlighter-rouge">P71_énumère</code> </td>
</tr>
<tr class="odd">
<td>P72</td>
<td>has language (is language of)</td>
<td>a pour langue (est la langue de)</td>
<td><code class="language-plaintext highlighter-rouge">P72_a_pour_langue</code> </td>
</tr>
<tr class="even">
<td>P73</td>
<td>has translation (is translation of)</td>
<td>a pour traduction (est traduction de)</td>
<td><code class="language-plaintext highlighter-rouge">P73_a_pour_traduction</code> </td>
</tr>
<tr class="odd">
<td>P74</td>
...
<td><code class="language-plaintext highlighter-rouge">P74_a_pour_résidence_actuelle_ou_antérieure</code> </td>
</tr>
<tr class="even">
<td>P75</td>
<td>possesses (is possessed by)</td>
<td>possède (est possédé par)</td>
<td><code class="language-plaintext highlighter-rouge">P75_possède</code> </td>
</tr>
<tr class="odd">
<td>P76</td>
<td>has contact point (provides access to)</td>
<td>a pour coordonnées (permet de contacter)</td>
<td><code class="language-plaintext highlighter-rouge">P76_a_pour_coordonnées</code> </td>
</tr>
<tr class="even">
<td>P79</td>
...
<td><code class="language-plaintext highlighter-rouge">P86_s’insère_dans</code> </td>
</tr>
<tr class="odd">
<td>P89</td>
<td>falls within (contains)</td>
<td>s’insère dans (inclut)</td>
<td><code class="language-plaintext highlighter-rouge">P89_s’insère_dans</code> </td>
</tr>
<tr class="even">
<td>P90</td>
<td>has value</td>
...
<td><p><code class="language-plaintext highlighter-rouge">P91_a_pour_unité_de_mesure</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P92_a_fait_exister</code> </td>
</tr>
<tr class="odd">
<td>P93</td>
<td>took out of existence (was taken out of existence by)</td>
<td>a mis fin à l'existence de (a cessé d'exister par)</td>
<td><code class="language-plaintext highlighter-rouge">P93_a_mis_fin_à_l’existence_de</code> </td>
</tr>
<tr class="even">
<td>P94</td>
<td>has created (was created by)</td>
<td>a créé (a été créé par)</td>
<td><code class="language-plaintext highlighter-rouge">P94_a_créé</code> </td>
</tr>
<tr class="odd">
<td>P95</td>
<td>has formed (was formed by)</td>
<td>a fondé (a été fondé par)</td>
<td><code class="language-plaintext highlighter-rouge">P95_a_fondé</code> </td>
</tr>
<tr class="even">
<td>P96</td>
<td>by mother (gave birth)</td>
<td>de mère (a donné naissance à)</td>
<td><code class="language-plaintext highlighter-rouge">P96_de_mère</code> </td>
</tr>
<tr class="odd">
<td>P97</td>
<td>from father (was father for)</td>
<td>de père (a été père pour)</td>
<td><code class="language-plaintext highlighter-rouge">P97_de_père</code> </td>
</tr>
<tr class="even">
<td>P98</td>
<td>brought into life (was born)</td>
<td>a donné vie à (est né)</td>
<td><code class="language-plaintext highlighter-rouge">P98_a_donné_vie_à</code> </td>
</tr>
<tr class="odd">
<td>P99</td>
<td>dissolved (was dissolved by)</td>
<td>a dissout (a été dissout par)</td>
<td><code class="language-plaintext highlighter-rouge">P99_a_dissout</code> </td>
</tr>
<tr class="even">
<td>P100</td>
<td>was death of (died in)</td>
<td>a été la mort de (est mort par)</td>
<td><code class="language-plaintext highlighter-rouge">P100_a_été_la_mort_de</code> </td>
</tr>
<tr class="odd">
<td>P101</td>
<td>had as general use (was use of)</td>
<td>a eu pour usage général (a été l'usage général de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P101_a_eu_pour_usage_général</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P102_a_pour_titre</code> </td>
</tr>
<tr class="odd">
<td>P103</td>
<td>was intended for (was intention of)</td>
<td>a eu pour raison d'être (a été raison d'être de)</td>
<td><code class="language-plaintext highlighter-rouge">P103_a_eu_pour_raison_d’être</code> </td>
</tr>
<tr class="even">
<td>P104</td>
<td>is subject to (applies to)</td>
<td>est soumis à (s’applique à)</td>
<td><code class="language-plaintext highlighter-rouge">P104_est_soumis_à</code> </td>
</tr>
<tr class="odd">
<td>P105</td>
<td>right held by (has right on)</td>
<td>droit détenu par (détient un droit sur)</td>
<td><code class="language-plaintext highlighter-rouge">P105_droit_détenu_par</code> </td>
</tr>
<tr class="even">
<td>P106</td>
<td>is composed of (forms part of)</td>
<td>est composé de (fait partie de)</td>
<td><code class="language-plaintext highlighter-rouge">P106_est_composé_de</code> </td>
</tr>
<tr class="odd">
<td>P107</td>
...
<td><code class="language-plaintext highlighter-rouge">P107_a_pour_membre_actuel_ou_antérieur</code> </td>
</tr>
<tr class="even">
<td>P108</td>
<td>has produced (was produced by)</td>
<td>a produit (a été produit par)</td>
<td><code class="language-plaintext highlighter-rouge">P108_a_produit</code> </td>
</tr>
<tr class="odd">
<td>P109</td>
...
<td><code class="language-plaintext highlighter-rouge">P109_a_pour_conservateur_actuel_ou_antérieur</code> </td>
</tr>
<tr class="even">
<td>P110</td>
<td>augmented (was augmented by)</td>
<td>a augmenté (a été augmenté par)</td>
<td><code class="language-plaintext highlighter-rouge">P110_a_augmenté</code> </td>
</tr>
<tr class="odd">
<td>P111</td>
<td>added (was added by)</td>
<td>a ajouté (a été ajouté par)</td>
<td><code class="language-plaintext highlighter-rouge">P111_a_ajouté</code> </td>
</tr>
<tr class="even">
<td>P112</td>
<td>diminished (was diminished by)</td>
<td>a diminué (a été diminué par)</td>
<td><code class="language-plaintext highlighter-rouge">P112_a_diminué</code> </td>
</tr>
<tr class="odd">
<td>P113</td>
<td>removed (was removed by)</td>
<td>a retiré (a été retiré par)</td>
<td><p><code class="language-plaintext highlighter-rouge">P113_a_retiré</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P123_a_eu_pour_résultat</code> </td>
</tr>
<tr class="odd">
<td>P124</td>
<td>transformed (was transformed by)</td>
<td>a transformé (a été transformé par)</td>
<td><code class="language-plaintext highlighter-rouge">P124_a_transformé</code> </td>
</tr>
<tr class="even">
<td>P125</td>
<td>used object of type (was type of object used in)</td>
<td>a utilisé un objet du type (a été le type d’objet employé pour)</td>
<td><code class="language-plaintext highlighter-rouge">P125_a_utilisé_un_objet_du_type</code> </td>
</tr>
<tr class="odd">
<td>P126</td>
<td>employed (was employed in)</td>
<td>a employé (a été employé dans)</td>
<td><code class="language-plaintext highlighter-rouge">P126_a_employé</code> </td>
</tr>
<tr class="even">
<td>P127</td>
<td>has broader term (has narrower term)</td>
<td>a pour terme général (a pour terme spécifique)</td>
<td><code class="language-plaintext highlighter-rouge">P127_a_pour_terme_général</code> </td>
</tr>
<tr class="odd">
<td>P128</td>
<td>carries (is carried by)</td>
<td>est support de (a pour support)</td>
<td><code class="language-plaintext highlighter-rouge">P128_est_support_de</code> </td>
</tr>
<tr class="even">
<td>P129</td>
<td>is about (is subject of)</td>
<td>a pour sujet (est sujet de)</td>
<td><code class="language-plaintext highlighter-rouge">P129_a_pour_sujet</code> </td>
</tr>
<tr class="odd">
<td>P130</td>
...
<td><code class="language-plaintext highlighter-rouge">P130_présente_des_caractéristiques</code> de (a_des_caractéristiques_également_présentes_sur) </td>
</tr>
<tr class="even">
<td>P132</td>
...
<td><code class="language-plaintext highlighter-rouge">P134_a_continué</code> </td>
</tr>
<tr class="odd">
<td>P135</td>
<td>created type (was created by)</td>
<td>a créé le type (a été créé par)</td>
<td><code class="language-plaintext highlighter-rouge">P135_a_créé_le_type</code> </td>
</tr>
<tr class="even">
<td>P136</td>
<td>was based on (supported type creation)</td>
<td>a été fondé sur (a fondé la création du type)</td>
<td><code class="language-plaintext highlighter-rouge">P136_a_été_fondé_sur</code> </td>
</tr>
<tr class="odd">
<td>P137</td>
<td>exemplifies (is exemplified by)</td>
<td>exemplifie (est exemplifié par)</td>
<td><code class="language-plaintext highlighter-rouge">P137_exemplifie</code> </td>
</tr>
<tr class="even">
<td>P138</td>
<td>represents (has representation)</td>
<td>représente (est représenté par)</td>
<td><code class="language-plaintext highlighter-rouge">P138_représente</code> </td>
</tr>
<tr class="odd">
<td>P139</td>
...
<td><code class="language-plaintext highlighter-rouge">P140_a_attribué_à</code> </td>
</tr>
<tr class="odd">
<td>P141</td>
<td>assigned (was assigned by)</td>
<td>a attribué (a été attribué par)</td>
<td><code class="language-plaintext highlighter-rouge">P141_a_attribué</code> </td>
</tr>
<tr class="even">
<td>P142</td>
<td>used constituent (was used in)</td>
<td>a utilisé comme élément (a été utilisé dans)</td>
<td><code class="language-plaintext highlighter-rouge">P142_a_utilisé_comme_élément</code> </td>
</tr>
<tr class="odd">
<td>P143</td>
<td>joined (was joined by)</td>
<td>a fait adhérer (a adhéré par)</td>
<td><p><code class="language-plaintext highlighter-rouge">P143_a_fait_adhérer</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P144_a_fait_adhérer_à</code> </td>
</tr>
<tr class="odd">
<td>P145</td>
<td>separated (left by)</td>
<td>a dissocié de (s'est dissocié par)</td>
<td><code class="language-plaintext highlighter-rouge">P145_a_dissocié_de</code> </td>
</tr>
<tr class="even">
<td>P146</td>
<td>separated from (lost member by)</td>
<td>s'est dissocié par (a perdu un membre par)</td>
<td><code class="language-plaintext highlighter-rouge">P146_s’est_dissocié_par</code> </td>
</tr>
<tr class="odd">
<td>P147</td>
<td>curated (was curated by)</td>
<td>a géré (a été géré par)</td>
<td><code class="language-plaintext highlighter-rouge">P147_a_géré</code> </td>
</tr>
<tr class="even">
<td>P148</td>
<td>has component (is component of)</td>
<td>a pour composant (est composant de)</td>
<td><p><code class="language-plaintext highlighter-rouge">P148_a_pour_composant</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P150_définit_les_éléments_typiques_de</code> </td>
</tr>
<tr class="even">
<td>P151</td>
<td>was formed from (participated in)</td>
<td>a été formé de (a participé à)</td>
<td><code class="language-plaintext highlighter-rouge">P151_a_été_formé_de</code> </td>
</tr>
<tr class="odd">
<td>P152</td>
<td>has parent (is parent of)</td>
<td>a pour parent (est parent de)</td>
<td><code class="language-plaintext highlighter-rouge">P152_a_pour_parent</code> </td>
</tr>
<tr class="even">
<td>P156</td>
<td>occupies (is occupied by)</td>
<td>occupe (est occupé par)</td>
<td><code class="language-plaintext highlighter-rouge">P156_occupe</code> </td>
</tr>
<tr class="odd">
<td>P157</td>
...
<td><code class="language-plaintext highlighter-rouge">P157_est_à_l’arrêt_par_rapport_à</code> </td>
</tr>
<tr class="even">
<td>P160</td>
...
<td><code class="language-plaintext highlighter-rouge">P160_a_pour_projection_temporelle</code> </td>
</tr>
<tr class="odd">
<td>P161</td>
<td>has spatial projection (is spatial projection of)</td>
<td>a pour projection spatiale (est la projection spatiale de)</td>
<td><code class="language-plaintext highlighter-rouge">P161_a_pour_projection_spatiale</code> </td>
</tr>
<tr class="even">
<td>P164</td>
<td>during (was time-span of)</td>
<td>durant (était l'intervalle temporel de)</td>
<td><code class="language-plaintext highlighter-rouge">P164_durant</code> </td>
</tr>
<tr class="odd">
<td>P165</td>
<td>incorporates (is incorporated in)</td>
<td>inclut (est inclus dans)</td>
<td><p><code class="language-plaintext highlighter-rouge">P165_inclut</code> </p>
...
<td><p><code class="language-plaintext highlighter-rouge">P166_a_été_une_présence_de</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P167_à</code> </td>
</tr>
<tr class="even">
<td>P168</td>
<td>place is defined by (defines place)</td>
<td>lieu défini par (définit le lieu)</td>
<td><code class="language-plaintext highlighter-rouge">P168_lieu_défini_par</code> </td>
</tr>
<tr class="odd">
<td>P169</td>
...
<td><code class="language-plaintext highlighter-rouge">P169_volume_spatio</code>-temporel_défini_par (définit_le_volume_spatio-temporel) </td>
</tr>
<tr class="even">
<td>P170</td>
<td>defines time (time is defined by)</td>
<td>temps défini par (définit le temps)</td>
<td><code class="language-plaintext highlighter-rouge">P170_temps_défini_par</code> </td>
</tr>
<tr class="odd">
<td>P171</td>
...
<td><code class="language-plaintext highlighter-rouge">P173_commence_avant_ou_au_moment_de_la_fin_de</code> </td>
</tr>
<tr class="even">
<td>P174</td>
<td>starts before the end of (ends after the start of)</td>
<td>commence avant la fin de (se termine après le début de)</td>
<td><code class="language-plaintext highlighter-rouge">P174_commence_avant_la_fin_de</code> </td>
</tr>
<tr class="odd">
<td>P175</td>
...
<td><code class="language-plaintext highlighter-rouge">P175_commence_avant_ou_au_moment_du_début_de</code> </td>
</tr>
<tr class="even">
<td>P176</td>
<td>starts before the start of (starts after the start of)</td>
<td>commence avant le début de (commence après le début de)</td>
<td><code class="language-plaintext highlighter-rouge">P176_commence_avant_le_début_de</code> </td>
</tr>
<tr class="odd">
<td>P177</td>
...
<td><code class="language-plaintext highlighter-rouge">P179_a_eu_pour_prix_de_vente</code> </td>
</tr>
<tr class="odd">
<td>P180</td>
<td>has currency (was currency of)</td>
<td>a pour monnaie (était la monnaie de)</td>
<td><code class="language-plaintext highlighter-rouge">P180_a_pour_monnaie</code> </td>
</tr>
<tr class="even">
<td>P181</td>
<td>has amount</td>
...
<td><code class="language-plaintext highlighter-rouge">P182_se_termine_avant_ou_au_moment_du_début_de</code> </td>
</tr>
<tr class="even">
<td>P183</td>
<td>ends before the start of (starts after the end of)</td>
<td>se termine avant le début de (commence après la fin de)</td>
<td><code class="language-plaintext highlighter-rouge">P183_se_termine_avant_le_début_de</code> </td>
</tr>
<tr class="odd">
<td>P184</td>
...
<td><code class="language-plaintext highlighter-rouge">P184_se_termine_avant_ou_au_moment_de_la_fin_de</code> </td>
</tr>
<tr class="even">
<td>P185</td>
<td>ends before the end of (ends after the end of)</td>
<td>se termine avant la fin de (se termine après la fin de)</td>
<td><code class="language-plaintext highlighter-rouge">P185_se_termine_avant_la_fin_de</code> </td>
</tr>
<tr class="odd">
<td>P186</td>
<td>produced thing of product type (is produced by)</td>
<td>a produit une chose du type (est produit par)</td>
<td><code class="language-plaintext highlighter-rouge">P186_a_produit_une_chose_du_type</code> </td>
</tr>
<tr class="even">
<td>P187</td>
<td>has production plan (is production plan for)</td>
<td>a pour plan de production (est le plan de production de)</td>
<td><code class="language-plaintext highlighter-rouge">P187_a_pour_plan_de_production</code> </td>
</tr>
<tr class="odd">
<td>P188</td>
<td>requires production tool (is production tool for)</td>
<td>nécessite l'outil (est l'outil de production de)</td>
<td><code class="language-plaintext highlighter-rouge">P188_nécessite_l’outil</code> </td>
</tr>
<tr class="even">
<td>P189</td>
<td>approximates (is approximated by)</td>
<td>approxime (est approximé par)</td>
<td><code class="language-plaintext highlighter-rouge">P189_approxime</code> </td>
</tr>
<tr class="odd">
<td>P190</td>
...
<td><code class="language-plaintext highlighter-rouge">P191_a_eu_pour_durée</code> </td>
</tr>
<tr class="odd">
<td>P195</td>
<td>was a presence of (had presence)</td>
<td>a été une présence de (a eu pour présence)</td>
<td><p><code class="language-plaintext highlighter-rouge">P195_a_été_une_présence_de</code> </p>
...
<td><code class="language-plaintext highlighter-rouge">P196_définit</code> </td>
</tr>
<tr class="odd">
<td>P197</td>
...
<td><code class="language-plaintext highlighter-rouge">P01_a_pour_domaine</code> </td>
</tr>
<tr class="odd">
<td>P02</td>
<td>has range (is range of)</td>
<td>a pour portée (est la portée de)</td>
<td><code class="language-plaintext highlighter-rouge">P02_a_pour_portée</code> </td>
</tr>
<tr class="even">
<td>P03</td>
...
<td>A utilisé l'objet spécifique (A été utilisé pour)</td>
<td><code class="language-plaintext highlighter-rouge">PC16_A_utilisé_l’objet_spécifique</code> </td>
</tr>
<tr class="even">
<td>P16.1</td>
<td>mode of use</td>
...
<td><code class="language-plaintext highlighter-rouge">PC19_Était_l’usage_prévu_de</code> </td>
</tr>
<tr class="even">
<td>P19.1</td>
<td>mode of use</td>
...
<td>A pour membre actuel ou antérieur (Est membre actuel ou antérieur de)</td>
<td><code class="language-plaintext highlighter-rouge">PC107_A_pour_membre_actuel_ou_antérieur</code> </td>
</tr>
<tr class="even">
<td>P107.1</td>
