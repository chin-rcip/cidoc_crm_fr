...
permalink: /v7.1.2/proprietes/P16
sidebar: v712
group: proprietes
date: 2023-11-08
---
...
<td class="en">
<ul>
<li><p>The writing of the scope note of the CIDOC CRM property “P16 used specific object” contained in the CIDOC CRM version 4.1 (E7) used specific object Nicholas Crofts’ computer (E22) mode of use Typing Tool; Storage Medium (E55). [the original scope note was later extended in the CIDOC CRM version 4.3] </p>
</li>
