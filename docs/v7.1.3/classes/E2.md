...
<li><p>the Peterhof Palace near Saint Petersburg being in ruins from 1944 to 1946 (E3) (Maddox, 2015)</p>
</li>
</ul>
</td>
<td>
...
<p>P175 starts before or with the start of (starts after or with the start of): E2 Temporal Entity</p>
...
<p><code class="language-plaintext highlighter-rouge">P173_commence_avant_ou_au_moment_de_la_fin_de (se_termine_après_ou_au_moment_du_début_de)</code> : <code class="language-plaintext highlighter-rouge">E2_Entité_temporelle</code></p>
