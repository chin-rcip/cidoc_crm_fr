...
permalink: /v7.1.3/proprietes/P11
sidebar: v713
group: proprietes
date: 2024-08-28
---
...
<td class="en">
<ul>
<li><p>Napoleon (E21) <em>participated in</em> The Battle of Waterloo (E7). (Dawson, 2018)</p>
</li>
<li><p>Maria (E21) <em>participated in </em>Photographing of Maria (E7). (fictitious)</p>
</li>
</ul>
</td>
<td>
...
<li><p>P11(x,y) ⇒ E39(y) </p>
</li>
<li><p>P11(x,y) ⇒ P12(x,y)</p>
</li>
</ul>
</td>
<td>
