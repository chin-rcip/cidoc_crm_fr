...
permalink: /v7.1.3/proprietes/P134
sidebar: v713
group: proprietes
date: 2024-08-28
---
...
<td class="en">
<ul>
<li><p>The construction of the Kölner Dom (Cologne Cathedral), abandoned in the 15<sup>th</sup> century (E7), <em>was</em> <em>continued by </em>construction in the 19<sup>th</sup> century (E7). [The construction in the 19<sup>th</sup> century adapted the initial plans so as to preserve the intended appearance.] (Wolff, 1999)</p>
</li>
</ul>
</td>
<td>
...
<td class="en">
<ul>
<li><p>P134(x,y) ⇒ E7(x)</p>
</li>
<li><p>P134(x,y)⇒ E7(y) </p>
</li>
<li><p>P134(x,y) ⇒ P15(x,y)</p>
</li>
<li><p>P134(x,y) ⇒ P176i(x,y)</p>
</li>
<li><p>P134(x,y) ⇒ ¬P134(y,x)</p>
</li>
</ul>
</td>
<td>
