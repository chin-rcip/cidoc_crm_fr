...
permalink: /v7.1.3/proprietes/P37
sidebar: v713
group: proprietes
date: 2024-08-28
---
...
<td class="en">
<p>This property records the identifier that was assigned to an item in an instance of E15 Identifier Assignment.</p>
...
<td class="en">
<ul>
<li><p>P37(x,y) ⇒ E15(x)</p>
</li>
<li><p>P37(x,y) ⇒ E42(y) </p>
</li>
<li><p>P37(x,y) ⇒ P141(x,y)</p>
</li>
</ul>
</td>
<td>
