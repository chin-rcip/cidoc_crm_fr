...
permalink: /v7.1.3/proprietes/P42
sidebar: v713
group: proprietes
date: 2024-08-28
---
...
<p>Type assignment events allow a more detailed path from E1 CRM Entity<em> </em>through<em> P41i was classified by, </em>E17 Type Assignment<em>, P42 assigned, </em>to E55 Type for assigning types to objects compared to the shortcut offered by <em>P2</em> <em>has type (is type of)</em>.</p>
...
<td class="en">
<ul>
<li><p>The classification of silver cup 232 on 31<sup>st</sup> August 1997 (E17) <em>assigned</em> goblet (E55). (fictitious) </p>
</li>
</ul>
</td>
<td>
...
<td class="en">
<ul>
<li><p>P42(x,y) ⇒ E17(x)</p>
</li>
<li><p>P42(x,y)⇒ E55(y) </p>
</li>
<li><p>P42(x,y) ⇒ P141(x,y)</p>
</li>
</ul>
</td>
<td>
