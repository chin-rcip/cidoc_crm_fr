...
<td colspan="2"><p>Le terme « continue » plutôt que « contiguë » a été retenu pour référer à la période de temps. Le terme « contigu » devant plutôt être utilisé pour parler de deux choses distinctes qui sont rapprochées par le sens ou par le temps.</p>
