...
<table>
				...
				<tr>
					...
					<td class="en"><p>This class comprises identifiable expressions in natural language or languages.</p>
							<p></p>
						...
						<td><p>Cette classe comprend les expressions identifiables en une ou plusieurs langues naturelles.</p>
							<p></p>
					...
					<td class="en"><ul><li><p>the text of the Ellesmere Chaucer manuscript (Hilmo, 2004)</p>
							</li>
						...
						<td><ul><li><p>Le texte du manuscrit <em>Ellesmere</em> de Chaucer (Hilmo, 2004)</p>
							</li>
					...
					<td class="en"><p>P72 has language (is language of): E56 Language</p>
							<p>P73 has translation (is translation of): E33 Linguistic Object</p>
							</td>
						<td><p><code class="language-plaintext highlighter-rouge">P72_a_pour_langue (est_la_langue_de)</code>  : <code class="language-plaintext highlighter-rouge">E56_Langue</code> </p>
