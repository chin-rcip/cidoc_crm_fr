...
<table>
				...
				<tr>
					...
					<td colspan="2"><p>CIDOC CRM. 2021. « CRMgeo ». 2021. http://www.cidoc-crm.org/crmgeo/home-5.</p>
							<p>Termium. 2009. « land use ». Termium Plus. 8 octobre 2009. https://www.btb.termiumplus.gc.ca/tpv2alpha/alpha-fra.html?lang=fra&i=1&srchtxt=land+use&index=alt&codom2nd_wet=1#resultrecs.</p>
							</td>
						</tr>
					</tbody>
				</table>
