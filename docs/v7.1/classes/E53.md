...
<table>
	...
	<tr>
		...
		<td class="en"><p>P89 falls within (contains): E53 Place<strong></strong></p>
			...
			<td><p><code class="language-plaintext highlighter-rouge">P89_s’insère_dans (inclut)</code> : <code class="language-plaintext highlighter-rouge">E53_Lieu</code> </p>
				...
				<p><code class="language-plaintext highlighter-rouge">P157_est_à_l’arrêt_par_rapport_à (procure_un_espace_de_référence_pour)</code> : <code class="language-plaintext highlighter-rouge">E18_Chose_matérielle</code></p>
