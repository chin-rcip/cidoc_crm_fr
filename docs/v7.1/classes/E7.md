				...
				<tr>
					...
					<td class="en"><p>This class comprises actions intentionally carried out by instances of E39 Actor that result in changes of state in the cultural, social, or physical systems documented.</p>
						...
						<td><p>Cette classe comprend les actions effectuées intentionnellement par des instances de <code class="language-plaintext highlighter-rouge">E39_Actant</code> qui ont pour résultat un changement d’état dans les systèmes culturels, sociaux ou physiques documentés.</p>
							<p></p>
							<p>Cette notion inclut des actions complexes, composées et de longue durée telles que la mise en place d’une installation ou une guerre, de même que des actions simples et éphémères telles que l’ouverture d’une porte.</p>
							</td>
						</tr>
					<tr>
					<td><strong>Exemples</strong></td>
					<td class="en"><ul><li><p>the Battle of Stalingrad (Hoyt, 1993)</p>
							</li>
						...
						<td><ul><li><p>La bataille de Stalingrad (Hoyt, 1993)</p>
							</li>
