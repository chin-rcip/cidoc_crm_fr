		...
		<td class="en"><ul><li><p>‘ecognizabl’</p>
			...
			<td><ul><li><p>‘econnaissabl’</p>
						...
						<li><p>Le panneau non-fumeur (<code class="language-plaintext highlighter-rouge">E36_Entité_visuelle</code>)</p>
							...
							<li><p>La distribution de la forme, du ton et de la couleur à la lumière du jour sur le tableau peint <em>Monna Lisa</em> de Léonard de Vinci (<code class="language-plaintext highlighter-rouge">E36_Entité_visuelle</code>)</p>
				</li>
