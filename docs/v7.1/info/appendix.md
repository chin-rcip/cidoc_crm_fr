...
<p>Le tableau « <a href="#instructions-de-migration-des-proprietés-depreciees-klb"><strong>Instructions de migration des propriétés dépréciées</strong></a> » énumère les propriétés dépréciées ainsi que celles qu’il est recommandé d’utiliser à la place de celles-ci. C’est un bon outil pour comprendre comment bien construire de nouveaux chemins sémantiques entre des instances de classes dépréciées et les remplacements de classes ou d’entités primitives qui sont recommandés.</p></td>
</tr>
</tbody>
</table>
<table>
