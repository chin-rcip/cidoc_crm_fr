...
<li><p>Faciliter les requêtes d’association dans des ressources intégrées en offrant un modèle global des classes de base et des associations entre elles qui permettent de formuler de telles requêtes. </p>
</li>
...
<td>
<p>Le domaine d’application global du CIDOC CRM peut être résumé, en termes simples, aux connaissances commissariées des musées [n.d.t. c.-à-d. les informations recensées dans les bases de données d’institutions patrimoniales].</p>
<p></p>
...
<hr><p></p>
<p></p>
<p><sup>1 </sup>Les statuts de l'ICOM fournissent une définition du terme « musée » à l'adresse <a href="http://icom.museum/statutes.html#2"><span class="underline">http://icom.museum/statutes.html#2</span></a>(page non accessible).</p>
