---
layout: page
title: P1 P1 est identifié par (identifie)
titleEn: P1 is identified by (identifies) - P1 est identifié par (identifie)
...
<table>
				...
				<tr>
					...
					<td class="en"><p>E1 CRM Entity. P48 has preferred identifier (is preferred identifier of): E42 Identifier</p>
						...
						<td><p><code class="language-plaintext highlighter-rouge">E1_Entité_CRM</code>. <code class="language-plaintext highlighter-rouge">P48_a_pour_identifiant_préférentiel (est_l'identifiant_préférentiel_de)</code> : <code class="language-plaintext highlighter-rouge">E42_Identifiant</code></p>
					...
					<td class="en"><ul><li><p>the capital of Italy (E53) <em>is identified by</em> “Rome” (E41) (Leach 2017)</p>
							</li>
									<li><p>text 25014–32 (E33) <em>is identified by</em> “The Decline and Fall of the Roman Empire” (E35) (Gibbon 2013)</p>
							</li></ul>
										</td>
						<td><ul><li><p>La capitale de l’Italie (<code class="language-plaintext highlighter-rouge">E53_Lieu</code>) est identifiée par (<code class="language-plaintext highlighter-rouge">P1_est_identifié_par</code>)« Rome » (<code class="language-plaintext highlighter-rouge">E41_Appellation</code>) (Leach, 2017)</p>
							</li>
