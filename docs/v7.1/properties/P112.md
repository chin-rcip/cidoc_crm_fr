...
<td class="en">
<p>This property identifies the instance E24 Physical Human-Made Thing that was diminished by an instance of E80 Part Removal. Although an instance of E80 Part removal activity normally concerns only one instance of E24 Physical Human-Made Thing, it is possible to imagine circumstances under which more than one item might be diminished by a single instance of E80 Part Removal activity. </p>
</td>
<td>
...
<td class="en">
<p>P112(x,y) ⇒ E80(x) P112(x,y) ⇒ E24(y) P112(x,y) ⇒ P31(x,y)</p>
</td>
<td>
<p>P112(x,y) ⇒ E80(x) P112(x,y) ⇒ E24(y) P112(x,y) ⇒ P31(x,y)</p>
</td>
