...
<table>
				...
				<tr>
					...
					<td class="en"><p>E4 Period. P7 took place at (witnessed) E53 Place</p>
							</td>
						<td><p><code class="language-plaintext highlighter-rouge">E4_Période</code>. <code class="language-plaintext highlighter-rouge">P7_a_eu_lieu_dans (a_été_témoin_de)</code> : <code class="language-plaintext highlighter-rouge">E53_Lieu</code></p>
							</td>
						</tr>
					<tr>
					...
					<td class="en"><p>one to many, necessary, dependent (1,n:0,n)</p>
							</td>
					...
					<td class="en"><p>This property associates an instance of an instance of E92 Spacetime Volume with an instance of E53 Place that is the result of the spatial projection of the instance of the E92 Spacetime Volume on a reference space.</p>
					...
					<td class="en"><ul><li><p>The Roman Empire <em>has spatial projection</em> all areas ever claimed by Rome. (Clare, 1992)</p>
							</li>
									</ul></td>
						<td><ul><li><p>L'Empire romain a pour projection spatiale (<code class="language-plaintext highlighter-rouge">P161_a_pour_projection_spatiale</code>) toutes les régions revendiquées par Rome (Clare, 1992)  </p>
							</li>
									</ul></td>
						</tr>
					<tr>
					<td><strong>Logique</strong></td>
					<td class="en"><p>P161(x,y) ⇒ E92(x) </p>
							<p>P161(x,y) ⇒ E53(y)</p>
							</td>
						<td><p>P161(x,y) ⇒ E92(x) </p>
							<p>P161(x,y) ⇒ E53(y)</p>
							</td>
						</tr>
					<tr>
