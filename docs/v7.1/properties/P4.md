---
layout: page
title: P4 P4 a pour intervalle temporel (est l’intervalle temporel de)
titleEn: P4 has time-span (is time-span of) - P4 a pour intervalle temporel (est l’intervalle temporel de)
